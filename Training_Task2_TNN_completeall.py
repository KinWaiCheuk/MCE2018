...
for alpha in [0.1, 0.5, 1, 5]:
    ...
    try:   
        fig.savefig(plot_folder+'Task2_trainall_acc_C'+str(alpha)+'.png')
    except:
    ...
    pickle.dump(loss_dict,open(plot_folder+'Dense600_loss_C'+str(alpha),'wb'))    
    pickle.dump(confusion_err_dict,open(plot_folder+'Dense600_confu_C'+str(alpha),'wb'))  
